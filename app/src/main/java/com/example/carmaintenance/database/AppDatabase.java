...
@Database(
        entities = {MaintenanceSession.class, MaintenanceItem.class, MaintenanceImage.class, TodoMaintenance.class},
        version = 6, // incremented version to add TodoMaintenance entity
        exportSchema = false
)
